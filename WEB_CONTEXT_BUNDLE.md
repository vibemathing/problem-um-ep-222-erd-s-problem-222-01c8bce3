...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-222-erd-s-problem-222-01c8bce3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-222"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-222-erd-s-problem-222-01c8bce3-v1",
      "problem_contract_sha256": "23b910cceeed4f9f087d1a9e4c0bccc516763ea48d15c659d1769126040c771a",
      "problem_id": "problem:um-ep-222-erd-s-problem-222-01c8bce3",
      "route_id": "route:um-ep-222-erd-s-problem-222-01c8bce3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-222-erd-s-problem-222-01c8bce3-source-fidelity-01",
      "graph_id": "graph:um-ep-222-erd-s-problem-222-01c8bce3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-222-erd-s-problem-222-01c8bce3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-222-erd-s-problem-222-01c8bce3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $n_1<n_2<\\cdots$ be the sequence of integers which are the sum of two squares. Explore the behaviour of (i.e. find good upper and lower bounds for) the consecutive differences $n_{k+1}-n_k$."
          },
          "statement_sha256": "906f0ec68e6a36d4db28b3698bdf58182aad566a83b6c2ba9c4b0fdb560794c9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-222-erd-s-problem-222-01c8bce3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-222-erd-s-problem-222-01c8bce3-root",
      "route_id": "route:um-ep-222-erd-s-problem-222-01c8bce3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-222-c5539924d156",
        "url": "https://www.unsolvedmath.com/problems/EP-222"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
